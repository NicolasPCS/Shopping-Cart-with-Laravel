...
class ClientController extends Controller
{
    ...
    public function access_account(Request $request) {
        $this->validate($request, ['email' => 'email|required', 'password' => 'required|min:4']);
        ...
        if ($client) {
            ...
            return back()->with('status', 'There is no an account with this email address available.');
        }
    }
    ...
    public function postcheckout(Request $request) {
        ...
        return redirect('/cart')->with('status', 'Your purchase order has been successfully processed!');
    }
}
